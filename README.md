...
The current release is **[0.6.0](https://github.com/Srimi1/Notch-hub/releases/latest)** — `NotchHub-0.6.0-universal.dmg`, a universal build that runs on both Apple Silicon and Intel.
